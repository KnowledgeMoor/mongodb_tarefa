package com.iftm.start_exemple.service;
...
import com.iftm.start_exemple.models.dto.UserDTO;
import com.iftm.start_exemple.repository.UserRepository;
...
public class UserService {
    ...
    public ResponseEntity<UserDTO> save(User user) { 
        //validar user
        if(user.getName().isBlank()||user.getAge()<=0)return ResponseEntity.badRequest().build();user.setId(ObjectId.get());
